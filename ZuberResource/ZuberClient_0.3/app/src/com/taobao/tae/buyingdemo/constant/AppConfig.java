...
public class AppConfig {
     ...
     * 注意：需要以 / 结尾
     */
    public final static String SERVER_DOMAIN = "http://1432300943990-1.wx.jaeapp.com/";

    //public final static String SERVER_DOMAIN ="http://taeandroid.cs.jaeapp.com/";

    /**
     * 当 App Crash后发送异常日志的接收者
     */
    public final static String APP_CRASH_REPORT_MAIL = "daijiale6239@qq.com";
     ...
     * 首页图片轮播间隔时间
     */
    public final static int AUTO_SCROLL_VIEW_PAGER_INTERVAL = 1000;
